"""
This script is called by the plugin-wrapper, tile_flips.js, which passes down the
...
from tile_flips import tile_flips
...
plugin = tile_flips(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
