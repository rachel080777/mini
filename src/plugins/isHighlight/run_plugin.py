"""
This script is called by the plugin-wrapper, isHighlight.js, which passes down the
...
from isHighlight import isHighlight

logger = logging.getLogger('isHighlight')
...
plugin = isHighlight(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
