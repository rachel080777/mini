"""
This script is called by the plugin-wrapper, countingPieces.js, which passes down the
...
from countingPieces import countingPieces
...
plugin = countingPieces(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
